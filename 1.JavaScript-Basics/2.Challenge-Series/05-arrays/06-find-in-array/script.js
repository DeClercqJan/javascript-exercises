...
(function() {
  ...
  document.getElementById("run").addEventListener("click", function() {
    console.log("test");
    console.log(people);
    function filter_function (person) {
        return (person.firstname == "Jean" && person.lastname == "Dupont");

    }
  people_filtered = people.filter(filter_function);
  people_filtered.forEach(element => {
    console.log(element.email);
});
console.log(people.findIndex(filter_function));
...
/*
 <p>When you click the button, display in the console the mail adress of the person in the array <strong>people</strong> whose lastname is 
    "Dupont" and  firstname is "Jean". Then display his <em>index</em> in this array.</p>
